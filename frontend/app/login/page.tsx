  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-dark gradient-mesh relative overflow-hidden">
      ...
      <div className="glass-card p-8 rounded-2xl shadow-2xl w-full max-w-md animate-scaleIn relative z-10">
        ...
        {/* Divider */}
        <div
          className="relative flex items-center my-6 animate-fadeIn stagger-4"
          style={{ opacity: 0 }}
        >
        ...
        <div className="animate-fadeIn stagger-5" style={{ opacity: 0 }}>
          <button
            onClick={() =>
        ...
        <div
          className="mt-6 text-center animate-fadeIn stagger-6"
          style={{ opacity: 0 }}
        >
